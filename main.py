...
# bot
TOKEN = os.environ.get("TOKEN", "5623546126:AAGqkev3gOFijeCt2tkcbVYuhHaLfYBrGvM")
bot = telebot.TeleBot(TOKEN)
GDTot_Crypt = os.environ.get("CRYPT","a2RHVENYaWgzTEdvVGg0S3QxaU5jZDdDOVdyNlkvVHBHZ2ZRcktYU012TT0%3D")
